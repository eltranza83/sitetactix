                      ...
                      {devMode && m.telemetry && (
                        ...
                        >
                          ...
                          {m.telemetry.latencyMetrics && (
                            <div style={{ margin: '4px 0', fontSize: '0.68rem', color: m.telemetry.latencyMetrics.retryOccurred ? '#F1D7A7' : '#94a3b8', display: 'flex', alignItems: 'center', gap: '4px', flexWrap: 'wrap' }}>
